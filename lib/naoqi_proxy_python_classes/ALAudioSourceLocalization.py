#!/usr/bin/env python
# Class autogenerated from .\alaudiosourcelocalizationproxy.h
...
class ALAudioSourceLocalization(object):
    def __init__(self, session):
        self.session = session
        self.proxy = None

    def force_connect(self):
        self.proxy = self.session.service("ALAudioSourceLocalization")
